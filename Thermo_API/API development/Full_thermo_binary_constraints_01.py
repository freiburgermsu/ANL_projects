...
class FullThermoPkg(BaseFBAPkg):
    ...
    def build_package(self,modelseed_path):
        ...
        for metabolite in self.model.metabolites:
            ...
            self.variables['dgbin'][metabolite.id] = self.build_variable(metabolite, 'dgbin')
    ...
    def build_constraint(self,object):
        #potential(i) (KJ/mol) = deltaG(i) (KJ/mol) + R * T(K) * lnconc(i) + charge(i) * compartment_potential - dgbin * potential(i)
        ...
        coef = {
            ...
            self.variables['dgbin'][object.id]: -constant
        }
